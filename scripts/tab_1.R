...
vars <- c("alt.count", "fam.count", "act.count", "ig.fam.count", "ig.fam.act.count", 
          "ig.fam.imm.count")
...
vars <- c("has.ig.fam", "has.ig.fam.act", "has.ig.fam.imm", 
          "deg.norm.cat", "deg.prop.cat", "betw.prop.cat")
